...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Beaver1) == 1
			and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Beaver2) == 1
			and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Beaver3) == 1 then
