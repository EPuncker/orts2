...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValue(PlayerStorageKeys.WhatAFoolishQuest.Questline) ~= 19
			or player:getStorageValue(PlayerStorageKeys.WhatAFoolishQuest.CatBasket) == 1 then
		return false
	end
