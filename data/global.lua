...
openDoors = {
	...
	17435, 19842, 19851, 19982, 19991, 20275, 20284, 22816, 22825, 25285, 25292
}
closedDoors = {
	...
	14640, 19841, 19850, 19981, 19990, 20274, 20283, 22815, 22824, 25284, 25291
}
lockedDoors = {
	...
	14641, 19840, 19849, 19980, 19989, 20273, 20282, 22814, 22823, 25283, 25290
}

openExtraDoors = {
	1540, 1542, 6796, 6798, 6800, 6802, 6960, 6962, 7055, 7057, 14635, 17236, 17238, 25159, 25161
}
closedExtraDoors = {
	1539, 1541, 6795, 6797, 6799, 6801, 6959, 6961, 7054, 7056, 14633, 17235, 17237, 25158, 25160
}
...
openHouseDoors = {
	...
	13021, 13023, 17236, 17238, 18209, 19844, 19853, 19984, 19993, 20277, 20286, 22818, 22827
}
closedHouseDoors = {
	...
	13020, 13022, 17235, 17237, 18208, 19843, 19852, 19983, 19992, 20276, 20285, 22817, 22826
}
