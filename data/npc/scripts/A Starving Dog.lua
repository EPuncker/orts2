	...
	elseif msgcontains(msg, "meat") then
		if npcHandler.topic[cid] == 1 then
			if player:removeItem(2666, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 2)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission01, 2) -- Questlog The Ice Islands Quest, Befriending the Musher
