...
local function greetCallback(cid)
	...
	elseif	player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) >= 1 then
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Yes") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 1)
