...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 5 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 1)
		...
		elseif npcHandler.topic[cid] == 6 then
				player:setStorageValue(PlayerStorageKeys.secretService.TBIMission01, 3)
				player:setStorageValue(PlayerStorageKeys.secretService.Quest, 3)
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(7696, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.TBIMission02, 2)
				player:setStorageValue(PlayerStorageKeys.secretService.Quest, 5)
		...
		elseif npcHandler.topic[cid] == 8 then
			if player:removeItem(14324, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.TBIMission03, 3)
				player:setStorageValue(PlayerStorageKeys.secretService.Quest, 7)
		...
		elseif npcHandler.topic[cid] == 9 then
			if player:removeItem(14325, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.TBIMission04, 2)
				player:setStorageValue(PlayerStorageKeys.secretService.Quest, 9)
		...
		elseif npcHandler.topic[cid] == 10 then
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission05, 3)
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 11)
			npcHandler:say('Now that Venore is of nearly no importance anymore, there is only Carlin left to deal with.', cid)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission06, 3)
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 13)
		...
		elseif npcHandler.topic[cid] == 13 then
			if player:removeItem(7699, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.Mission07, 2)
				player:setStorageValue(PlayerStorageKeys.secretService.Quest, 15)
	...
	elseif msgcontains(msg, 'join') then
		if player:getStorageValue(PlayerStorageKeys.secretService.Quest) < 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, 'mission') then
		if player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 1 and player:getStorageValue(PlayerStorageKeys.secretService.AVINMission01) < 1 and player:getStorageValue(PlayerStorageKeys.secretService.CGBMission01) < 1 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 2)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission01, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission01) == 2 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission01) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 3 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 4)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission02, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission02) == 1 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission02) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 5 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 6)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission03, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission03) == 2 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 8
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission03) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 7 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 8)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission04, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission04) == 1 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 9
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission04) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 9 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 10)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission05, 1)
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission05) == 2 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 10
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission05) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 11 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 12)
			player:setStorageValue(PlayerStorageKeys.secretService.TBIMission06, 1)
			player:addItem(7700, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission06) == 2 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 11
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission06) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 13 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 14)
			player:setStorageValue(PlayerStorageKeys.secretService.Mission07, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.TBIMission06) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Mission07) == 1 then
			npcHandler:say('Have you fulfilled your current mission?', cid)
			npcHandler.topic[cid] = 13
		end
	elseif msgcontains(msg, 'disguise') then
		if player:getStorageValue(PlayerStorageKeys.secretService.TBIMission06) == 1 then
