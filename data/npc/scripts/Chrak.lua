...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "battle") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 24 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 26 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 27)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission09, 3) --Questlog, The New Frontier Quest "Mission 09: Mortal Combat"
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission08, 2) --Questlog, The New Frontier Quest "Mission 08: An Offer You Can't Refuse"
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission09, 1) --Questlog, The New Frontier Quest "Mission 09: Mortal Combat"
			npcHandler.topic[cid] = 0
		end
	end
	return true
