...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'brooch') then
		if player:getStorageValue(PlayerStorageKeys.WhiteRavenMonasteryQuest.Passage) == 1 then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.WhiteRavenMonasteryQuest.Passage, 1)
			player:setStorageValue(PlayerStorageKeys.WhiteRavenMonasteryQuest.QuestLog, 1) -- Quest log
		end
