...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 1 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission01) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission01, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission01) == 1 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 2 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission02) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission02, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission02) == 2 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 3 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission03) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission03, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission03) == 2 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 4 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission04) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission04, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission04) == 7 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 5 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission05) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission05, 1)
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission05) == 1 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 6 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission06) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission06, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission06) == 3 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 7 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission07) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission07, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission07) == 1 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 8
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) == 8 and player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission08) < 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission08, 1)
		...
		elseif player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission08) == 2 then
			npcHandler:say('Have you finished your mission?', cid)
			npcHandler.topic[cid] = 9
		end
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 1)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 2 then
			if player:removeItem(3956, 10) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission01, 2)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 2)
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(8760, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission02, 3)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 3)
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(8761, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission03, 3)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 4)
				npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(8699, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission04, 8)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 5)
		...
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(8698, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission05, 2)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 6)
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(8766, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission06, 4)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 7)
		...
		elseif npcHandler.topic[cid] == 8 then
			if player:removeItem(8763, 1) then
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission07, 2)
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 8)
				npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 9 then
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission08, 3)
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Quest, 9)
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Door, 1)
			npcHandler:say({
	...
	elseif msgcontains(msg, 'thieves') then
		if player:getStorageValue(PlayerStorageKeys.thievesGuild.Quest) < 1 then
