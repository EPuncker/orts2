...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 2 then
			if player:removeItem(8190, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.CGBMission01, 2)
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(7736, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.CGBMission02, 2)
		...
		elseif npcHandler.topic[cid] == 4 then
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission03, 3)
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(7702, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.CGBMission04, 2)
		...
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(7703, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.CGBMission05, 2)
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(7704, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.CGBMission06, 2)
	...
	elseif msgcontains(msg, 'mission') then
		if player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 1 and player:getStorageValue(PlayerStorageKeys.secretService.TBIMission01) < 1 and player:getStorageValue(PlayerStorageKeys.secretService.CGBMission01) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission01, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission01) == 1 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission01) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 3 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 4)
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission02, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission02) == 1 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission02) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 5 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 6)
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission03, 1)
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission03) == 2 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission03) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 7 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 8)
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission04, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission04) == 1 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission04) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 9 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 10)
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission05, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission05) == 1 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission05) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 11 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 12)
			player:setStorageValue(PlayerStorageKeys.secretService.CGBMission06, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission06) == 1 then
			npcHandler:say('Have you been successful?', cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission06) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 13 then
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.CGBMission06) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Mission07) == 1 then
			npcHandler:say('Have you been successful?', cid)
