...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.SweetAsChocolateCake) < 1 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.SweetAsChocolateCake, 1)
		...
		elseif npcHandler.topic[cid] == 2 then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.SweetAsChocolateCake, 3)
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.DoorWestMine, 1)
