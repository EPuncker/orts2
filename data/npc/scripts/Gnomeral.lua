...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 16 and player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) < 17 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 17 then
	...
	elseif(msgcontains(msg, "matchmaker")) then
		if player:getStorageValue(PlayerStorageKeys.BigfootBurden.MissionMatchmaker) < 1 and player:getStorageValue(PlayerStorageKeys.BigfootBurden.MatchmakerTimeout) < os.time() and player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 16 then
			...
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionMatchmaker, 1)
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.MatchmakerStatus, 0)
			player:addItem(18313, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 1 or npcHandler.topic[cid] == 2) then
			if player:getStorageValue(PlayerStorageKeys.BigfootBurden.MatchmakerStatus) == 1 then
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.Rank, player:getStorageValue(PlayerStorageKeys.BigfootBurden.Rank) + 10)
				player:addItem(18422, 2)
				player:addItem(18215, 1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionMatchmaker, 0)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MatchmakerStatus, -1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MatchmakerTimeout, os.time() + 72000)
	...
	elseif(msgcontains(msg, "repair")) then
		if player:getStorageValue(PlayerStorageKeys.BigfootBurden.MissionTinkersBell) < 1 and player:getStorageValue(PlayerStorageKeys.BigfootBurden.TinkerBellTimeout) < os.time() and player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 16 then
			...
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionTinkersBell, 1)
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.GolemCount, 0)
			player:addItem(18343, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 1 or npcHandler.topic[cid] == 2) then
			if player:getStorageValue(PlayerStorageKeys.BigfootBurden.GolemCount) == 4 and player:removeItem(18343, 1) then
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.Rank, player:getStorageValue(PlayerStorageKeys.BigfootBurden.Rank) + 10)
				player:addItem(18422, 2)
				player:addItem(18215, 1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionTinkersBell, 0)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.GolemCount, -1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.TinkerBellTimeout, os.time() + 72000)
	...
	elseif(msgcontains(msg, "spore")) then
		if player:getStorageValue(PlayerStorageKeys.BigfootBurden.MissionSporeGathering) < 1 and player:getStorageValue(PlayerStorageKeys.BigfootBurden.SporeGatheringTimeout) < os.time() and player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 17 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionSporeGathering, 1)
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.SporeCount, 0)
			player:addItem(18328, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 2) then
			if player:getStorageValue(PlayerStorageKeys.BigfootBurden.SporeCount) == 4 and player:removeItem(18332, 1) then
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.Rank, player:getStorageValue(PlayerStorageKeys.BigfootBurden.Rank) + 10)
				player:addItem(18422, 2)
				player:addItem(18215, 1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionSporeGathering, 0)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.SporeCount, -1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.SporeGatheringTimeout, os.time() + 72000)
	...
	elseif(msgcontains(msg, "grindstone")) then
		if player:getStorageValue(PlayerStorageKeys.BigfootBurden.MissionGrindstoneHunt) < 1 and player:getStorageValue(PlayerStorageKeys.BigfootBurden.GrindstoneTimeout) < os.time() and player:getStorageValue(PlayerStorageKeys.BigfootBurden.QuestLine) >= 17 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionGrindstoneHunt, 1)
			player:setStorageValue(PlayerStorageKeys.BigfootBurden.GrindstoneStatus, 0)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 2) then
			if player:getStorageValue(PlayerStorageKeys.BigfootBurden.GrindstoneStatus) == 1 and player:removeItem(18337, 1) then
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.Rank, player:getStorageValue(PlayerStorageKeys.BigfootBurden.Rank) + 10)
				player:addItem(18422, 2)
				player:addItem(18215, 1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.MissionGrindstoneHunt, 0)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.GrindstoneStatus, -1)
				player:setStorageValue(PlayerStorageKeys.BigfootBurden.GrindstoneTimeout, os.time() + 72000)
