...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "nokmir") then
		if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll) == 2 then
	...
	elseif msgcontains(msg, "rerun") then
		if npcHandler.topic[cid] == 1 then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll, 3)
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.TheGoodGuard) < 1 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.TheGoodGuard) == 1 and player:removeItem(9689, 1) then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.TheGoodGuard, 2)
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.DoorSouthMine, 1)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 2 then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.TheGoodGuard, 1)
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.DefaultStart, 1)
