...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "join") then
		if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) < 1 then
			npcHandler:say("Do you want to join the inquisition?", cid)
			npcHandler.topic[cid] = 2
		end
	elseif msgcontains(msg, "blessing") or msgcontains(msg, "bless") then
		if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 25 then --if quest is done
	...
	elseif msgcontains(msg, "mission") or msgcontains(msg, "report") then
		if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) < 1 then
			npcHandler:say("Do you want to join the inquisition?", cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 2)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission01, 1) -- The Inquisition Questlog- "Mission 1: Interrogation"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 2 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 3 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 4)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission02, 1) -- The Inquisition Questlog- "Mission 2: Eclipse"
			player:addItem(7494, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 5 then
			if player:removeItem(8702, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 6)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission02, 3) -- The Inquisition Questlog- "Mission 2: Eclipse"
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission03, 1) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			else
				npcHandler:say("You need bring me the witches' grimoire.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) > 5 and player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) < 11 then
			npcHandler:say("Your current mission is to help the vampire hunter Storkus. Are you done with that mission? ", cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 11 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 12)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission04, 1) -- The Inquisition Questlog- "Mission 4: The Haunted Ruin"
			player:addItem(7494, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 12 or player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 13 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 14 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 15)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission05, 1) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 15 then
			if player:removeItem(6500, 20) then
				...
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 16)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission05, 2) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			else
				npcHandler:say("You need 20 of them.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 17 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 18)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission06, 1) -- The Inquisition Questlog- "Mission 6: The Demon Ungreez"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 19 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission06, 3) -- The Inquisition Questlog- "Mission 6: The Demon Ungreez"
			player:addOutfitAddon(288, 1)
			player:addOutfitAddon(289, 1)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 20 then
			npcHandler:say("Destroy the shadow nexus using this vial of holy water and kill all demon lords.", cid)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 21)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission07, 1) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
			player:addItem(7494, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 21 or player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 22 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 3 then
			if player:getStorageValue(PlayerStorageKeys.TheInquisition.WalterGuard) == 1 and player:getStorageValue(PlayerStorageKeys.TheInquisition.KulagGuard) == 1 and player:getStorageValue(PlayerStorageKeys.TheInquisition.GrofGuard) == 1 and player:getStorageValue(PlayerStorageKeys.TheInquisition.MilesGuard) == 1 and player:getStorageValue(PlayerStorageKeys.TheInquisition.TimGuard) == 1 then
				npcHandler:say({
				...
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 3)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission01, 7) -- The Inquisition Questlog- "Mission 1: Interrogation"
			else
				npcHandler:say("You haven't done your mission yet.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 4 then
			if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 10 then
				...
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 11)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission03, 6) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			else
				npcHandler:say("You haven't done your mission with {Storkus} yet.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 5 then
			if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 13 then
				npcHandler:say("Well, this was an easy task, but your next mission will be much more challenging. ", cid)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 14)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission04, 3) -- The Inquisition Questlog- "Mission 4: The Haunted Ruin"
			else
				npcHandler:say("You haven't done your mission with {Storkus} yet.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 6 then
			if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 22 then
				...
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 23)
				player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission07, 3) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
	...
	elseif msgcontains(msg, "outfit") then
		if player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 16 then
			npcHandler:say("Here is your demon hunter outfit. You deserve it. Unlock more addons by completing more missions.", cid)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 17)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission05, 3) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			player:addOutfit(288, 0)
			player:addOutfit(289, 0)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheInquisition.Questline) == 23 then
			npcHandler:say("Here is the final addon for your demon hunter outfit. Congratulations!", cid)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Questline, 24)
			player:setStorageValue(PlayerStorageKeys.TheInquisition.Mission07, 4) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
