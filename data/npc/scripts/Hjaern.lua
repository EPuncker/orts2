...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 3 then
			if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Mission02) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission02, 1) -- Questlog The Ice Islands Quest, Nibelor 1: Breaking the Ice
			npcHandler.topic[cid] = 0
			end
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 5)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission02, 5) -- Questlog The Ice Islands Quest, Nibelor 1: Breaking the Ice
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 29 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 31 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 38 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 39)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission11, 2) -- Questlog The Ice Islands Quest, Formorgar Mines 3: The Secret
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission12, 1) -- Questlog The Ice Islands Quest, Formorgar Mines 4: Retaliation
			player:addItem(7289, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 39
				and player:getStorageValue(PlayerStorageKeys.TheIceIslands.Obelisk01) == 5
				and player:getStorageValue(PlayerStorageKeys.TheIceIslands.Obelisk02) == 5
				and player:getStorageValue(PlayerStorageKeys.TheIceIslands.Obelisk03) == 5
				and player:getStorageValue(PlayerStorageKeys.TheIceIslands.Obelisk04) == 5 then
			if player:removeItem(7289, 1) then
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 40)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.yakchalDoor, 1)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission12, 6) -- Questlog The Ice Islands Quest, Formorgar Mines 4: Retaliation
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.NorsemanAddon, 1) -- Questlog Norseman Outfit Quest
	...
	elseif msgcontains(msg, "shard") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 40 then
			npcHandler:say("Do you bring frostheart shards for our spell?", cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 42 then
			npcHandler:say("Do you bring frostheart shards for our spell? ", cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 44 then
	...
	elseif msgcontains(msg, "reward") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 41 then
			npcHandler:say("Take this. It might suit your Nordic outfit fine. ", cid)
			player:addOutfitAddon(252, 1)
			player:addOutfitAddon(251, 1)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 42)
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.NorsemanAddon, 2) -- Questlog Norseman Outfit Quest
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 43 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 44)
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.NorsemanAddon, 3) -- Questlog Norseman Outfit Quest
			npcHandler.topic[cid] = 4
		end
	elseif msgcontains(msg, "tylaf") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 36 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 37)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission10, 1) -- Questlog The Ice Islands Quest, Formorgar Mines 2: Ghostwhisperer
			npcHandler.topic[cid] = 0
		end
	elseif msgcontains(msg, 'cookie') then
		if player:getStorageValue(PlayerStorageKeys.WhatAFoolishQuest.Questline) == 31
				and player:getStorageValue(PlayerStorageKeys.WhatAFoolishQuest.CookieDelivery.Hjaern) ~= 1 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 30)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission07, 2) -- Questlog The Ice Islands Quest, The Secret of Helheim
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 32)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission08, 1) -- Questlog The Ice Islands Quest, The Contact
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 3 then
			if layer:removeItem(7290, 5) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 41)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(7290, 10) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 43)
				npcHandler.topic[cid] = 0
			end
		...
		elseif npcHandler.topic[cid] == 6 then
			...
			player:setStorageValue(PlayerStorageKeys.WhatAFoolishQuest.CookieDelivery.Hjaern, 1)
