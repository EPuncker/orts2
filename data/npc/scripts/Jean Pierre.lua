...
local function playerHasIngredients(cid)
	...
	local table = ingredients[player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish)]
	if table then
		for i = 1, #table do
...
local function greetCallback(cid)
	local player = Player(cid)
	if player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) < 1 then
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "recipe") or msgcontains(msg, "menu") then
		...
		if player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 1 then
			if player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 1 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 2 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 3 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 4 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 5 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 6 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 7 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 8 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 9 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 10 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 11 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 12 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 13 then
				npcHandler:say({
			...
			elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish) == 14 then
				npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 3 then
			...
			player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart, 1)
			player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 1)
			player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 1)
		elseif npcHandler.topic[cid] == 5 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 2)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 2)
		...
		elseif npcHandler.topic[cid] == 7 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 3)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 3)
		...
		elseif npcHandler.topic[cid] == 9 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 4)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 4)
		...
		elseif npcHandler.topic[cid] == 11 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 5)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 5)
		...
		elseif npcHandler.topic[cid] == 13 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 6)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 6)
		...
		elseif npcHandler.topic[cid] == 15 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 7)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 7)
		...
		elseif npcHandler.topic[cid] == 17 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 8)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 8)
		...
		elseif npcHandler.topic[cid] == 19 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 9)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 9)
		...
		elseif npcHandler.topic[cid] == 21 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 10)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 10)
		...
		elseif npcHandler.topic[cid] == 23 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 11)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 11)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CookbookDoor, 1)
		...
		elseif npcHandler.topic[cid] == 25 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 12)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 13)
		...
		elseif npcHandler.topic[cid] == 27 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 13)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 14)
		...
		elseif npcHandler.topic[cid] == 29 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 14)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 15)
		...
		elseif npcHandler.topic[cid] == 31 then
			if playerHasIngredients(cid) then
				...
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart, 2)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.CurrentDish, 15)
				player:setStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestLog, 16)
	...
	elseif msgcontains(msg, "rotworm stew") then
		if npcHandler.topic[cid] == 4 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "hydra tongue salad") then
		if npcHandler.topic[cid] == 6 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "roasted dragon wings") then
		if npcHandler.topic[cid] == 8 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "tropical fried terrorbird") then
		if npcHandler.topic[cid] == 10 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "banana chocolate shake") then
		if npcHandler.topic[cid] == 12 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "veggie casserole") then
		if npcHandler.topic[cid] == 14 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "filled jalapeño peppers") then
		if npcHandler.topic[cid] == 16 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "blessed steak") then
		if npcHandler.topic[cid] == 18 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "northern fishburger") then
		if npcHandler.topic[cid] == 20 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "carrot cake") then
		if npcHandler.topic[cid] == 22 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "coconut shrimp bake") then
		if npcHandler.topic[cid] == 24 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "blackjack") then
		if npcHandler.topic[cid] == 26 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "demonic candy ball") then
		if npcHandler.topic[cid] == 28 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(msg, "sweet mangonaise elixir") then
		if npcHandler.topic[cid] == 30 or player:getStorageValue(PlayerStorageKeys.HotCuisineQuest.QuestStart) == 2 then
