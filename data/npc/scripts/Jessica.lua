...
local voices = {
	{ text = 'Leave your money with me where it\'s safe!' },
	{ text = 'Gems, jewels... all a woman could dream of is right here.' }
}
...
npcHandler:setMessage(MESSAGE_GREET, 'Greetings stranger. Let me know if you want to {trade} gems or jewellery.')
