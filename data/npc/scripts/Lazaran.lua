...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 9 then
	...
	elseif msgcontains(msg, "help") and player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) < 1 then
		npcHandler:say({
	...
	elseif msgcontains(msg, "mission") and player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) >= 1 then
		if player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 1 then
			npcHandler:say("Oh! You found holy skull? In bone pile you found?! Thank Pandor you brought! Me can have it back?", cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 2 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 3 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 4 then
			npcHandler:say("We been weak for too long! We prepare for great hunt. But still need many doings! You can help us?", cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 13 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 14)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission06, 2) --Questlog, Unnatural Selection Quest "Mission 6: Firewater Burn"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 14 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 1)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission01, 1) --Questlog, Unnatural Selection Quest "Mission 1: Skulled"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 2 then
			if player:removeItem(11076, 1) then
				npcHandler:say("Me thank you much! All wisdom safe again now.", cid)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 2)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission01, 3) --Questlog, Unnatural Selection Quest "Mission 1: Skulled"
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 3 then
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 3)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission02, 1) --Questlog, Unnatural Selection Quest "Mission 2: All Around the World"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 4 then
			if player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission02) == 12 and player:getItemCount(11076) >= 1 then
				...
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 4)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission02, 13) --Questlog, Unnatural Selection Quest "Mission 2: All Around the World"
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 5 then
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 5)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission03, 1) --Questlog, Unnatural Selection Quest "Mission 3: Dance Dance Evolution"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(2562, 1, 3) then
				npcHandler:say("We make big ritual soon and learn much about world outside. Me thank you many times for teaching us world. Very wise and adventurous you are!", cid)
				player:addItem(11115, 1)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 15)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission06, 3) --Questlog, Unnatural Selection Quest "Mission 6: Firewater Burn"
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 11 then
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 10)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission03, 2) --Questlog, The New Frontier Quest "Mission 03: Strangers in the Night"
			npcHandler.topic[cid] = 0
		end
	end
	return true
