...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "outfit") or msgcontains(msg, "addon") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) < 1 then
	...
	elseif msgcontains(msg, "mail") or msgcontains(msg, "dragon scale mail") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) == 2 then
	...
	elseif msgcontains(msg, "legs") or msgcontains(msg, "crown legs") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) == 3 then
	...
	elseif msgcontains(msg, "ring") or msgcontains(msg, "ring of the sky") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) == 4 then
	...
	elseif msgcontains(msg, "task") then
		if player:getStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers) <= 0 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers) == 1 then
			if player:getStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancerCount) >= 4000 then
				npcHandler:say({
				...
				player:setStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers, 2)
			else
				npcHandler:say("Come back when you have slain {4000 necromancers and priestesses!}", cid)
			end
		elseif player:getStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers) == 2 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers, 3)
		elseif player:getStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers) == 3 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 1)
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(2536, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 2)
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(2492, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 3)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(2488, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 4)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(2123, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 5)
		...
		elseif npcHandler.topic[cid] == 7 then
			...
			player:setStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers, 1)
			player:setStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancerCount, 0)
		elseif npcHandler.topic[cid] == 8 then
			npcHandler:say("Good. Then go.", cid)
			player:setStorageValue(PlayerStorageKeys.KillingInTheNameOf.LugriNecromancers, 4)
		end
