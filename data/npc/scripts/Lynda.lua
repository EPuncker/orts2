...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "angelina") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) == 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "wand") or msgcontains(msg, "rod") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) == 2 then
			npcHandler:say("Did you bring a sample of each wand and each rod with you?", cid)
			npcHandler.topic[cid] = 3
		end
	elseif msgcontains(msg, "sulphur") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) == 3 then
			npcHandler:say("Did you obtain 10 ounces of magic sulphur?", cid)
			npcHandler.topic[cid] = 4
		end
	elseif msgcontains(msg, "soul stone") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) == 4 then
			npcHandler:say("Were you actually able to retrieve the Necromancer's soul stone?", cid)
			npcHandler.topic[cid] = 5
		end
	elseif msgcontains(msg, "ankh") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand) == 5 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 2)
		...
		elseif npcHandler.topic[cid] == 3 then
			if  player:getItemCount(2181) > 0 and player:getItemCount(2182) > 0 and player:getItemCount(2183) > 0 and player:getItemCount(2185) > 0 and player:getItemCount(2186) > 0 and player:getItemCount(2187) > 0 and player:getItemCount(2188) > 0 and player:getItemCount(2189) > 0 and player:getItemCount(2190) > 0 and player:getItemCount(2191) > 0 then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 3)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(5904, 10) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 4)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(5809, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 5)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(2193, 20) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.MageSummoner.AddonWand, 6)
