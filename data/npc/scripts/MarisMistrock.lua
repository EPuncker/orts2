...
keywordHandler:addKeyword({'mistrock'}, StdModule.say, {npcHandler = npcHandler,
	...
	}}, nil, function(player) if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.WayToBeregar) ~= 1 then player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.WayToBeregar, 1) end end
)
