...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 4) then
			npcHandler:say({
		...
		elseif(player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 6) then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 7)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission02, 6) --Questlog, The New Frontier Quest "Mission 02: From Kazordoon With Love"
		end
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 5)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission02, 2) --Questlog, The New Frontier Quest "Mission 02: From Kazordoon With Love"
	...
	elseif msgcontains(msg, "buy flask") or msgcontains(msg, "flask") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 5 then
