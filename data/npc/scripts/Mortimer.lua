...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "join") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) < 1 then
			npcHandler:say("Do you want to join the explorer society?", cid)
			npcHandler.topic[cid] = 1
		end
	--The New Frontier
	elseif msgcontains(msg, "farmine") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 15 then
	...
	elseif msgcontains(msg, "bluff") then
		if npcHandler.topic[cid] == 30 then
			if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeExplorerSociety) < 1 then
				npcHandler:say({
				...
				player:setStorageValue(PlayerStorageKeys.TheNewFrontier.BribeExplorerSociety, 1)
				--Questlog, The New Frontier Quest "Mission 05: Getting Things Busy"
				player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission05, player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Mission05) + 1)
			end
		end

	-- SPECTRAL STONE
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 51 then
			npcHandler:say("Oh, yes! Tell our fellow explorer that the papers are in the mail already.", cid)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 52)
	...
	elseif msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 46 then
			npcHandler:say("Do you have some collected ectoplasm with you?", cid)
			npcHandler.topic[cid] = 28
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 47 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 49 then
			npcHandler:say("Did you bring the dress?", cid)
			npcHandler.topic[cid] = 30
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 50 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 51)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 52 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 53 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 54)
			player:addItem(7242, 1)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 56 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 57 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 59 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 60)
	...
	elseif msgcontains(msg, "pickaxe") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) < 4 or player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) > 1 then
	...
	elseif msgcontains(msg, "butterfly hunt") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 7 then
			npcHandler:say("The mission asks you to collect some species of butterflies, are you interested?", cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 9 then
			npcHandler:say("Did you acquire the purple butterfly we are looking for?", cid)
			npcHandler.topic[cid] = 8
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 10 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 11)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 12 then
			npcHandler:say("Did you acquire the blue butterfly we are looking for?", cid)
			npcHandler.topic[cid] = 9
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 13 then
			npcHandler:say({
				"This preparation kit will allow you to collect a blue butterfly you have killed ...",
			...
			npcHandler.topic[cid] = 0
			player:addItem(4865, 1)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 14)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 14 then
	...
	elseif msgcontains(msg, "ice delivery") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 4 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 6 then
	...
	elseif msgcontains(msg, "plant collection") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 15 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 17 then
			npcHandler:say("Did you acquire the sample of the jungle bells plant we are looking for?", cid)
			npcHandler.topic[cid] = 12
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 18 then
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 19)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 20 then
			npcHandler:say("Did you acquire the sample of the witches cauldron we are looking for?", cid)
			npcHandler.topic[cid] = 13
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 22 then
			npcHandler:say("Use this botanist's container on a witches cauldron to collect a sample for us. Bring it here and report about your plant collection.", cid)
			npcHandler.topic[cid] = 0
			player:addItem(4869, 1)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 23)
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 25 then
	...
	elseif msgcontains(msg, "lizard urn") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 26 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 28 then
	...
	elseif msgcontains(msg, "bonelord secrets") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 29 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 31 then
	...
	elseif msgcontains(msg, "orc powder") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 32 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 34 then
	...
	elseif msgcontains(msg, "elven poetry") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 35 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 37 then
	...
	elseif msgcontains(msg, "memory stone") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 38 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 40 then
	...
	elseif msgcontains(msg, "rune writings") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 41 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 43 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 1)
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(4848, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 4)
				npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 4 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 5)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(11421, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 7)
		...
		elseif npcHandler.topic[cid] == 7 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 8)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 8 then
			if player:removeItem(4868, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 10)
		...
		elseif npcHandler.topic[cid] == 9 then
			if player:removeItem(4866, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 13)
				npcHandler:say("A little bit battered but it will do. Thank you! If you think you are ready, ask for another butterfly hunt.", cid)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 10 then
			if player:removeItem(4867, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 15)
		...
		elseif npcHandler.topic[cid] == 11 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 16)
		...
		elseif npcHandler.topic[cid] == 12 then
			if player:removeItem(4870, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 18)
		...
		elseif npcHandler.topic[cid] == 13 then
			if player:removeItem(4871, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 21)
		...
		elseif npcHandler.topic[cid] == 14 then
			if player:removeItem(4872, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 26)
		...
		elseif npcHandler.topic[cid] == 15 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 27)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.urnDoor, 1)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 16 then
			if player:removeItem(4858, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 29)
		...
		elseif npcHandler.topic[cid] == 17 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 30)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.bonelordsDoor, 1)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 18 then
			if player:removeItem(4857, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 32)
		...
		elseif npcHandler.topic[cid] == 19 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 33)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.orcDoor, 1)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 20 then
			if player:removeItem(15389, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 35)
		...
		elseif npcHandler.topic[cid] == 21 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 36)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.elvenDoor, 1)
		...
		elseif npcHandler.topic[cid] == 22 then
			if player:removeItem(4855, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 38)
		...
		elseif npcHandler.topic[cid] == 23 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 39)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.edronDoor, 1)
		...
		elseif npcHandler.topic[cid] == 24 then
			if player:removeItem(4852, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 41)
		...
		elseif npcHandler.topic[cid] == 25 then
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 42)
		...
		elseif npcHandler.topic[cid] == 26 then
			if player:removeItem(4853, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 44)
		...
		elseif npcHandler.topic[cid] == 27 then
			npcHandler:say({
				...
				"Don't lose the container. They are expensive!"
			}, cid)
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 45)
			player:addItem(4863, 1)
		elseif npcHandler.topic[cid] == 28 then
			if player:removeItem(4864, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 47)
		...
		elseif npcHandler.topic[cid] == 29 then
			...
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 48)
		elseif npcHandler.topic[cid] == 30 then
			if player:removeItem(4847, 1) then
				player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 50)
		...
		elseif npcHandler.topic[cid] == 31 then
			...
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 53)
		-- SPECTRAL STONE
		...
		elseif npcHandler.topic[cid] == 32 then
			...
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 57)
		-- ISLAND OF DRAGONS
