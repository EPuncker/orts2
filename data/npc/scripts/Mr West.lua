...
local function greetCallback(cid)
	...
	if(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestDoor) == 1) then
	...
	elseif(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestDoor) == 2) then
	...
	if(msgcontains(msg, "mission")) then
		if(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 24) then
			if(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestDoor) == 1) then
				...
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 25)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 3) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestStatus, 1)
			...
			elseif(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestDoor) == 2) then
				...
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 25)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 4) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestStatus, 2)
				npcHandler.topic[cid] = 0
			end
		end
	end
