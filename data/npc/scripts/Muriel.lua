...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'mission') then
		...
		elseif player:getStorageValue(PlayerStorageKeys.TibiaTales.IntoTheBonePit) == 1 then
			npcHandler:say({
			...
			addEvent(releasePlayer, 1000, cid)
		elseif player:getStorageValue(PlayerStorageKeys.TibiaTales.IntoTheBonePit) == 2 then
			player:setStorageValue(PlayerStorageKeys.TibiaTales.IntoTheBonePit, 3)
	...
	elseif msgcontains(msg, 'yes') then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TibiaTales.IntoTheBonePit, 1)
			npcHandler:say({
