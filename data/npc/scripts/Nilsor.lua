...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 20 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 28 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 29)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission07, 1) -- Questlog The Ice Islands Quest, The Secret of Helheim
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) > 20 and player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) < 28 then
	...
	elseif msgcontains(msg, "water") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 22 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "sulphur") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 23 then
	...
	elseif msgcontains(msg, "herb") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 24 then
	...
	elseif msgcontains(msg, "blossom") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 25 then
	...
	elseif msgcontains(msg, "hydra tongue") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 26 then
	...
	elseif msgcontains(msg, "spores") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 27 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 21)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 1) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 2 then
			if player:getTotalMoney() >= 25 then
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(7245, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 22)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 2) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(7246, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 23)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 3) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(8301, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 24)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 4) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(7248, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 25)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 5) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(7249, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 26)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 6) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient. ", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 8 then
			if player:removeItem(7250, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 27)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 7) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient.", cid)
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 9 then
			if player:removeItem(7251, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 28)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission06, 8) -- Questlog The Ice Islands Quest, Nibelor 5: Cure the Dogs
			else
				npcHandler:say("Come back when you have the ingredient.", cid)
			end
			npcHandler.topic[cid] = 0
