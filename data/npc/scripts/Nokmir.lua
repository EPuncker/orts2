...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll) < 1 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll) == 5 then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll, 6)
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.DoorNorthMine, 1)
	...
	elseif msgcontains(msg, "rehal") then
		if npcHandler.topic[cid] == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.JusticeForAll, 1)
