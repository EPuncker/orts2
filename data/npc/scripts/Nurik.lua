...
local function greetCallback(cid)
	...
	if player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission04) ~= 6 or player:getOutfit().lookType ~= 66 then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 4 then
			...
			if player:removeItem(8694, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission04, 7)
				npcHandler:say({
