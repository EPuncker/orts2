...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "report")) then
		if(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 8 or player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 12) then
