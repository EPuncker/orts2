...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.QuestStart) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.QuestStart, 1)
			npcHandler.topic[cid] = 1
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission01) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission02) < 1 then
			npcHandler:say("Ah hello, young friend! Did you bring me two ghoul snacks as requested?", cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission02) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission03) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission03, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission03) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission04) < 1 then
			npcHandler:say("Ah hello again! You look as if you could, er, lend me a hand or two? Yes?", cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission04) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission05) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission05, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission06) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission07) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission07) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission08) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission08, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission09) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission10) < 1 then
			npcHandler:say("Yes, yes, hello. Tell me if you lost something. If not, do you have that stimulated brain with you?", cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission10) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission11) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission11, 1)
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission12) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission13) < 1 then
			npcHandler:say("Hello, hello. Let's come to the point - did you find me some intestines?", cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission13) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission14) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission15) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission16) < 1 then
			npcHandler:say("Ah hello! Well done there, I felt the old powers settling down. Now, {ready} to hallow the next altar?", cid)
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission16, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission16) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission18) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission20) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission21) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission21, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission21) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission22) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission22, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission25) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission26) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission26, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission29) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission30) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission30, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission33) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission34) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission34, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission42) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission43) < 1 then
			npcHandler:say('Yes? Do you have the scroll piece? ', cid)
			npcHandler.topic[cid] = 11
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission43) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission44) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission44, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission50) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission51) < 1 then
			npcHandler:say("Ah, hello! I take it you have the next scroll piece for me, {yes}?", cid)
			npcHandler.topic[cid] = 12
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission51) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission52) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission52, 1)
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission57) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission58) < 1 then
			npcHandler:say("Hello - what? You have the {scroll} piece, you say?", cid)
			npcHandler.topic[cid] = 13
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission58) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission59) < 1 then
			player:addItem(21464, 1)
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission59, 1)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission68) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69) < 1 then
			npcHandler:say("Welcome, welcome! Finally! The last scroll piece.... you do have it, haven't you?", cid)
			npcHandler.topic[cid] = 15
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission70) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission71) < 1 then
			npcHandler:say("Don't keep me waiting. The last scroll piece - were you able to {restore} it?", cid)
			npcHandler.topic[cid] = 16
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission73) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission74) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission74, 1)
			player:addItem(21452, 1)
		end
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.QuestStart) == 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission01, 1)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 2 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission01) == 1 then
			if player:removeItem(12423, 2) then
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission02, 1)
		...
		elseif npcHandler.topic[cid] == 3 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission03) == 1 then
			if player:removeItem(10564, 2) then
				...
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission04, 1)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have two demonic skeletal hands.", cid)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 4 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission06) == 1 then
			if player:removeItem(21394, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission07, 1)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have my heart.", cid)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 5 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission09) == 1 then
			if player:removeItem(21395, 1) then
				npcHandler:say("Ah... <sighs> Very good. Just say the word when you are ready for the next {mission}.", cid)
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission10, 1)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have the brain.", cid)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 6 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission12) == 1 then
			if player:removeItem(21403, 1) then
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission13, 1)
				npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission22) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission23) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission23, 1)
		elseif npcHandler.topic[cid] == 9 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission26) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission27) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission27, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 10 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission34) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission35) < 1 then
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission35, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission42) == 1 then
			if player:removeItem(21250, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission43, 1)
				npcHandler.topic[cid] = 0
			else
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission43) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission44) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission44, 1)
		elseif npcHandler.topic[cid] == 12 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission50) == 1 then
			if player:removeItem(21250, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission51, 1)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have my scroll.", cid)
				npcHandler.topic[cid] = 0
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission51) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission52) < 1 then
			...
			player:addItem(21489, 1)
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission52, 1)
		elseif npcHandler.topic[cid] == 13 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission57) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission58) < 1 then
			if player:removeItem(21250, 1) then
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission58, 1)
				npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 14 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission64) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission65) < 1 then
			if player:removeItem(21250, 1) then
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission65) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission66) < 1 then
			...
			player:addItem(21464, 1)
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission66, 1)
		elseif npcHandler.topic[cid] == 15 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission68) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69) < 1 then
			if player:removeItem(21250, 1) then
				player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69, 1)
				npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 17 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission71) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission72) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission72, 1)
	...
	elseif msgcontains(msg, 'give') and npcHandler.topic[cid] == 4 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission06) == 1 then
		if player:removeItem(21394, 1) then
			npcHandler:say("Ah... <sighs> Very good. Just say the word when you are ready for the next {mission}.", cid)
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission07, 1)
			npcHandler.topic[cid] = 0
	...
	elseif msgcontains(msg, 'undertake') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission13) == 1 and npcHandler.topic[cid] == then
		npcHandler:say({
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission14, 1)
		player:addItem(21401,3)
		npcHandler.topic[cid] = 0
	elseif msgcontains(msg, 'ready') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission16) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17) < 1 then
		npcHandler:say({
			"I expected no less. Next is the Bonemarrow Altar, where the Dark Lord feasts upon the hallowed bones of...err. ...",
			"Ahem. Just take a yellowed bone or big bone, and hallow it - you don't know how? ...",
			"Huh. To HALLOW a yellowed bone, use it with one of the hallowed bonepiles in the Gardens Of Night. There are always bones around there - or were, in my days. ...",
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17, 1)
	elseif msgcontains(msg, 'problem') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission17) == 1 and npcHandler.topic[cid] == 8 then
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission18, 1)
		player:addItem(21407, 3)
		npcHandler.topic[cid] = 0
	elseif msgcontains(msg, 'blood') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission21) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission22) < 1 then
		npcHandler:say({
			"Yes, I said blood. Important ingredient in necromantic rituals, usually. ...",
			"You need to spill some vials of blood tincture for this task. Probably means killing blood priests to get those vials. Ready to do this?"
		}, cid)
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission22, 1)
	elseif msgcontains(msg, 'proceed') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission30) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission31) < 1 then
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission31, 1)
	...
	elseif msgcontains(msg, 'scroll') then
		if player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission34) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission35) < 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, 'next') then
		if player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission43) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission44) < 1 then
			npcHandler:say({
				"Hah, developed a taste for it, have you? I believe the next scroll piece was hidden somewhere, my old friend being of a somewhat distrustful nature. ...",
				"The scent may not be lost, though - ask a shadow pupil if he can help - but be careful. ...",
				"Those shadow pupils are - strange. Try to find one who will answer and not kill you!"
	...
	elseif msgcontains(msg, 'restore') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission70) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission71) < 1 and npcHandler.topic[cid] == 16 then
		if player:removeItem(21474, 1) then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission71, 1)
