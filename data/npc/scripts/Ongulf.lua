...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "project") and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) < 1 then
	...
	elseif msgcontains(msg, "short") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 1)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission01, 1) --Questlog, The New Frontier Quest "Mission 01: New Land"
			npcHandler.topic[cid] = 0
		end
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) < 1 and npcHandler.topic[cid] == 2 then
			npcHandler:say({
				"Listen, I can handle the organisation down here and my boys will handle the construction of the base fine enough. Actually, all you do down here is to stand in the workers' way. ...",
				"But there might be something for you to do outside the base. We need to learn more about the land up there. Take the lift and do some exploring. Find a passage leading out of the mountains. ...",
				"Do not explore any further though. You never know whom you might be messing with."
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission01, 1) --Questlog, The New Frontier Quest "Mission 01: New Land"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 3)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission01, 3) --Questlog, The New Frontier Quest "Mission 01: New Land"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 3 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 4)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission02, 1) --Questlog, The New Frontier Quest "Mission 02: From Kazordoon With Love"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 7 then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 8)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 8 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 9)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission03, 1) --Questlog, The New Frontier Quest "Mission 03: Strangers in the Night"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 10 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 11)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission03, 3) --Questlog, The New Frontier Quest "Mission 03: Strangers in the Night"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 11 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 12)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission04, 1) --Questlog, The New Frontier Quest "Mission 04: The Mine Is Mine"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 13 then
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 14)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 14 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 15)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission05, 1) --Questlog, The New Frontier Quest "Mission 05: Getting Things Busy"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 15 then
			if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeKing) == 1 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeLeeland) == 1 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeExplorerSociety) == 1 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeWydrin) == 1 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeTelas) == 1 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeHumgolf) == 1 then
				...
				player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 16)
				npcHandler.topic[cid] = 0
			end
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 16 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 17)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission06, 1) --Questlog, The New Frontier Quest "Mission 06: Days Of Doom"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 20 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 21)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 21 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 22)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission07, 1) --Questlog, The New Frontier Quest "Mission 07: Messengers Of Peace"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) == 27 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Questline, 28)
			player:setStorageValue(PlayerStorageKeys.TheNewFrontier.Mission10, 1) --Questlog, The New Frontier Quest "Mission 10: New Horizons"
			npcHandler.topic[cid] = 0
		end
	end
	return true
