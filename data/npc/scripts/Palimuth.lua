...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) < 1 then
		player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 3)
	end

	if msgcontains(msg, "job") and not player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 54 then
	...
	elseif msgcontains(msg, "job") then
		if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 54 then
			npcHandler:say("Did you bring me the vampiric crest?", cid)
			npcHandler.topic[cid] = 6
		end
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 3 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 4 then
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission01, 1) -- StorageValue for Questlog "Mission 01: Something Rotten"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 5)
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 5 then
			npcHandler:say("So are you done with your work?", cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 6 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) >= 7 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) <= 14 then
			npcHandler:say("Did you get all the reports my superiors asked for? ", cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 15 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 1) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 16)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.NotesPalimuth, 0)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.NotesPalimuth) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 16 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 2) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 17)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToAzerus, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 20 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 21)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToBog, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 5) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 23 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 24)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 2) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 25 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestStatus) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) + 1 or 0)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 26)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 5) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 28 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 29)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.TamerinStatus, 0)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission05, 2) -- StorageValue for Questlog "Mission 05: Food or Fight"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 32 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.TamerinStatus) == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) + 1 or 0) -- Side Storage
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 33)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission05, 8) -- StorageValue for Questlog "Mission 05: Food or Fight"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 35 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 36)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission06, 2) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 37 then
			if player:removeItem(9742, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 38)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission06, 4) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraState, 1)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) + 1 or 0) -- Side Storage
				npcHandler.topic[cid] = 0
			end
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 40 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToQuara, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission07, 2) -- StorageValue for Questlog "Mission 07: A Fishy Mission"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 42 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraState) == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 43)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission07, 5) -- StorageValue for Questlog "Mission 07: A Fishy Mission"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide) + 1 or 0) -- Side Storage
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 44 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 45)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToMatrix, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission08, 2) -- StorageValue for Questlog "Mission 08: Dangerous Machinations"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 48 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 49)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 49 or player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 48 then
			npcHandler:say("So do you want to side with me? ", cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 50 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 51)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToLastFight, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission10, 2) -- StorageValue for Questlog "Mission 10: The Final Battle"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 52 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 53)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.DoorToReward, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission10, 4) -- StorageValue for Questlog "Mission 10: The Final Battle"
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 4)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 2 then
			if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SewerPipe01) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SewerPipe02) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SewerPipe03) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SewerPipe04) == 1 then
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 6)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission01, 6) -- StorageValue for Questlog "Mission 01: Something Rotten"
		...
		elseif npcHandler.topic[cid] == 3 then
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission02, 1) -- StorageValue for Questlog "Mission 02: Watching the Watchmen"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 7)
			npcHandler:say({
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 14 then
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission02, 8) -- StorageValue for Questlog "Mission 02: Watching the Watchmen"
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 15)
		...
		elseif npcHandler.topic[cid] == 5 then
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 50)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission09, 2) -- StorageValue for Questlog "Mission 09: Decision"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission10, 1) -- StorageValue for Questlog "Mission 10: The Final Battle"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision, 1)
		...
		elseif npcHandler.topic[cid] == 6 then
			if player:getItemCount(9956) > 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 54 then
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 55)
				npcHandler:say("Great! Here, take this yalaharian addon in a return.", cid)
				player:addOutfitAddon(325, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 1 and 1 or 2)
				player:addOutfitAddon(324, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 1 and 1 or 2)
				player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you do.", cid)
