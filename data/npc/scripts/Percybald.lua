...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'disguise') then
		if player:getStorageValue(PlayerStorageKeys.thievesGuild.TheatreScript) < 0 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.thievesGuild.TheatreScript, 0)
		end
	elseif msgcontains(msg, 'test') then
		if player:getStorageValue(PlayerStorageKeys.thievesGuild.Mission04) == 5 then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(PlayerStorageKeys.thievesGuild.Mission04, 6)
