...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(os.date("%A") == "Monday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission01) < 1) then
			...
			elseif(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission01) == 1) then
				npcHandler:say("Have you managed to obtain a rare deer trophy for my customer?", cid)
				npcHandler.topic[cid] = 3
			end
		elseif(os.date("%A") == "Tuesday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission01) == 2 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission02) < 1 ) then
				npcHandler:say("So, my friend, are you willing to proceed to the next mission to become a recognised trader?", cid)
				npcHandler.topic[cid] = 4
			elseif(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission02) == 4) then
				npcHandler:say("Did you bring me the package?", cid)
				npcHandler.topic[cid] = 6
			end
		elseif(os.date("%A") == "Wednesday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission02) == 5 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission03) < 1 ) then
				npcHandler:say("So, my friend, are you willing to proceed to the next mission to become a recognised trader?", cid)
		...
		elseif(os.date("%A") == "Thursday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission03) == 3 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission04) < 1) then
				npcHandler:say("So, my friend, are you willing to proceed to the next mission to become a recognised trader?", cid)
				npcHandler.topic[cid] = 10
			elseif(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission04) == 2) then
				npcHandler:say("Have you brought the vase?", cid)
				npcHandler.topic[cid] = 12
			end
		elseif(os.date("%A") == "Friday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission04) == 3 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission05) < 1) then
				npcHandler:say("So, my friend, are you willing to proceed to the next mission to become a recognised trader?", cid)
				npcHandler.topic[cid] = 13
			elseif(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission05) == 2) then
				npcHandler:say("Have you brought a cheap but good crimson sword?", cid)
				npcHandler.topic[cid] = 15
			end
		elseif(os.date("%A") == "Saturday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission05) == 3 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission06) < 1) then
				npcHandler:say("So, my friend, are you willing to proceed to the next mission to become a recognised trader?", cid)
				npcHandler.topic[cid] = 16
			elseif(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission06) == 1) then
				npcHandler:say("Have you brought me a gold fish??", cid)
				npcHandler.topic[cid] = 18
			end
		elseif(os.date("%A") == "Sunday") then
			if(player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission06) == 2 and player:getStorageValue(PlayerStorageKeys.TravellingTrader.Mission07) ~= 1) then
				npcHandler:say("Ah, right. <ahem> I hereby declare you - one of my recognised traders! Feel free to offer me your wares!", cid)
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission07, 1)
	...
	elseif(msgcontains(msg, "yes")) then
		...
		elseif(npcHandler.topic[cid] == 2) then
			...
			player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission01, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 3) then
			if player:removeItem(7397, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission01, 2)
				npcHandler.topic[cid] = 0
			end
		...
		elseif(npcHandler.topic[cid] == 8) then
			...
			player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission03, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 9) then
			if player:removeItem(8112, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission03, 3)
				npcHandler.topic[cid] = 0
			end
		...
		elseif(npcHandler.topic[cid] == 11) then
			...
			player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission04, 1)
		...
		elseif(npcHandler.topic[cid] == 12) then
			if player:removeItem(8760, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission04, 3)
				npcHandler.topic[cid] = 0
			end
		...
		elseif(npcHandler.topic[cid] == 14) then
			...
			player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission05, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 15) then
			if player:removeItem(7385, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission05, 3)
				npcHandler.topic[cid] = 0
			end
		...
		elseif(npcHandler.topic[cid] == 17) then
			...
			player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission06, 1)
			npcHandler.topic[cid] = 0
		elseif(npcHandler.topic[cid] == 18) then
			if player:removeItem(8766, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TravellingTrader.Mission06, 2)
				npcHandler.topic[cid] = 0
			end
		end
	end
...
local function onTradeRequest(cid)
	if Player(cid):getStorageValue(PlayerStorageKeys.TravellingTrader.Mission07) ~= 1 then
