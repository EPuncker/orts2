...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "report")) then
		if(player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 10 or player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 11) then
