...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		if player:getStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.RoyalRescue) == 4 and player:removeItem(14350, 1) then
			player:setStorageValue(PlayerStorageKeys.hiddenCityOfBeregar.RoyalRescue, 5)
