...
local voices = { {text = 'Don\'t run into the mines with too much money in your pockets. Better leave it here.'} }
...
npcHandler:setMessage(MESSAGE_GREET, 'Hiho, hiho, |PLAYERNAME|! Welcome to the {bank}! What can I do for you?')
