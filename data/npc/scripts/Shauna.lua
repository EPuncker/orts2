...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "job") then
		if Player(cid):getStorageValue(PlayerStorageKeys.DjinnWar.EfreetFaction.Mission01) == 2 then
	...
	elseif msgcontains(msg, "prisoner") then
		if npcHandler.topic[cid] == 2 then
			...
			Player(cid):setStorageValue(PlayerStorageKeys.DjinnWar.EfreetFaction.Mission01, 3)
