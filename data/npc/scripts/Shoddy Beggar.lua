...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'device') then
		if player:getStorageValue(PlayerStorageKeys.SeaOfLightQuest.Questline) == 1 then
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(PlayerStorageKeys.SeaOfLightQuest.Questline, 2)
			player:setStorageValue(PlayerStorageKeys.SeaOfLightQuest.Mission1, 2)
