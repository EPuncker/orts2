...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 5 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 7 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 9 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 10)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 11)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 1) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 11 then
			npcHandler:say("Do you have the 5 bat wings I requested?", cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 12 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 13)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 2) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 13 then
			npcHandler:say("Do you have the 4 bear paws I requested?", cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 14 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 15)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 3) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 15 then
			npcHandler:say("Do you have the 3 bonelord eyes I requested?", cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 16 then
			npcHandler:say("The next things needed are 2 fish fins. Bring them to me and Ill tell you the next ingredients we need.", cid)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 17)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 4) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 17 then
			npcHandler:say("Do you have the 2 fish fins I requested?", cid)
			npcHandler.topic[cid] = 8
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 18 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 19)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 5) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.TheIceIslands.Questline) == 19 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 6)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission03, 1) -- Questlog The Ice Islands Quest, Nibelor 2: Ecological Terrorism
		...
		elseif npcHandler.topic[cid] == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 8)
			player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission04, 1) -- Questlog The Ice Islands Quest, Nibelor 3: Artful Sabotage
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 5 then -- Wings
			if player:removeItem(5894, 5) then
				npcHandler:say("Thank you very much.", cid)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 12)
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 6 then -- Paws
			if player:removeItem(5896, 4) then
				npcHandler:say("Thank you very much.", cid)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 14)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you do.", cid)
			end
		...
		elseif npcHandler.topic[cid] == 7 then -- Eyes
			if player:removeItem(5898, 3) then
				npcHandler:say("Thank you very much.", cid)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 16)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you do.", cid)
			end
		...
		elseif npcHandler.topic[cid] == 8 then -- Fins
			if player:removeItem(5895, 2) then
				npcHandler:say("Thank you very much.", cid)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 18)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you do.", cid)
			end
		...
		elseif npcHandler.topic[cid] == 9 then -- Scale
			if player:removeItem(5920, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Questline, 20)
				player:setStorageValue(PlayerStorageKeys.TheIceIslands.Mission05, 6) -- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("Come back when you do.", cid)
			end
	...
	if msgcontains(msg, "buy animal cure") or msgcontains(msg, "animal cure") then -- animal cure for in service of yalahar
		if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) >= 30 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) <= 54 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 13 then
		if npcHandler.topic[cid] == 13 and player:getTotalMoney() >= 400 then
			player:addItem(9734, 1)
			player:removeTotalMoney(400)
