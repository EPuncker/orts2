...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "kiss") and npcHandler.topic[cid] == 7 then
		if player:getStorageValue(PlayerStorageKeys.QueenOfBansheesQuest.Kiss) < 1 then
	...
	elseif msgcontains(msg, "spectral dress") then
		if player:getStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine) == 48 then
			...
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.QuestLine, 49)
			player:setStorageValue(PlayerStorageKeys.ExplorerSociety.bansheeDoor, 1)
		end
	elseif msgcontains(msg, "addon") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) == 5 then
	...
	elseif msgcontains(msg, "orchid") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon) == 6 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 8 then
			if not player:isPzLocked() then
				...
				player:setStorageValue(PlayerStorageKeys.QueenOfBansheesQuest.Kiss, 1)
			else
		...
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 6)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			if player:removeItem(5922, 50) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.WizardAddon, 7)
