...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, 'scroll') or msgcontains(msg, 'mission')) and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission35) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission36) < 1 then
		npcHandler:say({
	...
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission35) == 1 then
		npcHandler:say({
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission36, 1)
		player:addItem(21417, 2)
		npcHandler.topic[cid] = 0
	elseif(msgcontains(msg, 'scroll') or msgcontains(msg, 'mission') or msgcontains(msg, 'blood')) and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission37) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission38) < 1 then
		npcHandler:say("Hello hello! Did you bring those blood samples?", cid)
		npcHandler.topic[cid] = 2
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 2 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission37) == 1 then
		if player:getItemCount(21419) >= 1 and player:getItemCount(21418) >= 1 then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission38, 1)
	...
	elseif(msgcontains(msg, 'scroll') or msgcontains(msg, 'mission')) and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission40) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission41) < 1 then
		npcHandler:say("Hello hello! Did Hello hello! Well now, painted all those blood pagodas properly?", cid)
		npcHandler.topic[cid] = 3
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 3 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission40) == 1 then
		npcHandler:say({
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission41, 1)
		npcHandler.topic[cid] = 0
	elseif(msgcontains(msg, 'scroll') or msgcontains(msg, 'mission')) and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission41) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission42) < 1 then
		npcHandler:say("Hello hell- oh, you've come for the scroll, haven't you?", cid)
		npcHandler.topic[cid] = 4
	elseif msgcontains(msg, 'yes') and npcHandler.topic[cid] == 4 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission41) == 1 then
		...
		player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission42, 1)
