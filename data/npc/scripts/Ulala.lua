...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 5 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 6 then
			npcHandler:say("Come back if you finished the dance.", cid)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 7 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 8)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission04, 1) --Questlog, Unnatural Selection Quest "Mission 4: Bits and Pieces"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 8 then
			npcHandler:say("Please help tribe make Pandor happy! Did you bring us what I asked?", cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 9 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 10)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission05, 1) --Questlog, Unnatural Selection Quest "Mission 5: Ray of Light"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 10 then
			npcHandler:say("Please find great crystal of Fasuon and pray there for his support!", cid)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 11 then
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 12)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission05, 3) --Questlog, Unnatural Selection Quest "Mission 5: Ray of Light"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline) == 12 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 13)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission06, 1) --Questlog, Unnatural Selection Quest "Mission 6: Firewater Burn"
			npcHandler.topic[cid] = 0
		end
	elseif msgcontains(msg, "krunus") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 6)
			player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission03, 2) --Questlog, Unnatural Selection Quest "Mission 3: Dance Dance Evolution"
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 2 then
			if player:getItemCount(11113) >= 5 and player:getItemCount(5878) >= 5 and player:getItemCount(5876) >= 5 then
				...
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Questline, 9)
				player:setStorageValue(PlayerStorageKeys.UnnaturalSelection.Mission04, 2) --Questlog, Unnatural Selection Quest "Mission 4: Bits and Pieces"
				npcHandler.topic[cid] = 0
			else
