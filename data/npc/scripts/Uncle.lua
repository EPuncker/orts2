...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 2 then
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission01, 4)
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(7705, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.AVINMission02, 2)
		...
		elseif npcHandler.topic[cid] == 4 then
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission03, 4)
		...
		elseif npcHandler.topic[cid] == 5 then
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission04, 3)
		...
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(7708, 1) then
				player:setStorageValue(PlayerStorageKeys.secretService.AVINMission05, 2)
		...
		elseif npcHandler.topic[cid] == 7 then
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission06, 3)
	...
	elseif msgcontains(msg, 'mission') then
		if player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 1 and player:getStorageValue(PlayerStorageKeys.secretService.TBIMission01) < 1 and player:getStorageValue(PlayerStorageKeys.secretService.CGBMission01) < 1 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 2)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission01, 1)
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission01) == 3 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 2
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission01) == 4 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 3 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 4)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission02, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission02) == 1 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission02) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 5 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 6)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission03, 1)
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission03) == 3 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission03) == 4 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 7 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 8)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission04, 1)
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission04) == 2 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 5
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission04) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 9 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 10)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission05, 1)
			npcHandler:say('I need you to locate a lost ring on the Isle of the Kings for me, get back to me once you have it.', cid)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission05) == 1 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 6
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission05) == 2 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 11 then
			player:setStorageValue(PlayerStorageKeys.secretService.Quest, 12)
			player:setStorageValue(PlayerStorageKeys.secretService.AVINMission06, 1)
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission06) == 2 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission06) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Quest) == 13 then
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.secretService.AVINMission06) == 3 and player:getStorageValue(PlayerStorageKeys.secretService.Mission07) == 1 then
			npcHandler:say('Do you have news to make old Uncle happy?', cid)
