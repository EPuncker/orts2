...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 17 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 18)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 3) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.NotesAzerus, 0)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.NotesAzerus) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 18 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 19)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 19 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 20)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 4) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 21 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.AlchemistFormula) == 1 then
			npcHandler:say("So you have killed the plague carriers. Have you also retrieved the research papers? ", cid)
			npcHandler.topic[cid] = 1
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 22 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 23)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 1) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 26 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 27)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 6) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 25 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MrWestStatus) == 2 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) + 1 or 0) -- Side Storage
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 27)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission04, 6) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 27 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 28)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission05, 1) -- StorageValue for Questlog "Mission 05: Food or Fight"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 33 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 34)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 32 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.TamerinStatus) == 2 then
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 34 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 35)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission06, 1) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
			player:addItem(9737, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 38 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 39)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission06, 5) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
			npcHandler.topic[cid] = 0
		...
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 39 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 40)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission07, 1) -- StorageValue for Questlog "Mission 07: A Fishy Mission"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 41 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraInky) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraSharptooth) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraSplasher) == 1 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.QuaraState) == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) + 1 or 0) -- Side Storage
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 43 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 44)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission08, 1) -- StorageValue for Questlog "Mission 08: Dangerous Machinations"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 46 then
			if player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MatrixState) == 1 then
			...
			elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.MatrixState) == 2 then
				npcHandler:say("Now we will have power we truly deserve!...", cid)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide, player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) >= 0 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide) + 1 or 0) -- Side Storage
			end
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 47)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission08, 4) -- StorageValue for Questlog "Mission 08: Dangerous Machinations"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 47 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 48)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission09, 1) -- StorageValue for Questlog "Mission 09: Decision"
			npcHandler.topic[cid] = 0
		...
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 50 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 2 then
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline) == 52 and player:getStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision) == 2 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			if player:removeItem(9733, 1) then
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.BadSide, 1)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 22)
				player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 6) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.SideDecision, 2)
	...
	elseif msgcontains(msg, "no") then
		if npcHandler.topic[cid] == 1 then
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.GoodSide, 1)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Questline, 22)
			player:setStorageValue(PlayerStorageKeys.InServiceofYalahar.Mission03, 6) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			npcHandler:say({
