...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		if player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 2 then
			npcHandler:say("What newzz do you bring? Did you find any cluezz about zzeir whereaboutzz? ", cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 3 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 5 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 6)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission01, 3) --Questlog, Children of the Revolution "Mission 1: Corruption"
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 6 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 7 then
			if player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.SpyBuilding01) == 1 and player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.SpyBuilding02) == 1 and player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.SpyBuilding03) == 1 then
				npcHandler:say({
				...
				player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 8)
				player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission02, 5) --Questlog, Children of the Revolution "Mission 2: Imperial Zzecret Weaponzz"
				npcHandler.topic[cid] = 0
			end
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 8 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 11 then
			npcHandler:say({
			...
			npcHandler.topic[cid] = 0
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 12)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission03, 3) --Questlog, Children of the Revolution "Mission 3: Zee Killing Fieldzz"
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 12 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 17 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 18 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 20 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 21)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission05, 3) --Questlog, Children of the Revolution "Mission 5: Phantom Army"
		...
		elseif player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline) == 21 and player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 1 then
			npcHandler:say("Ah you have returned. I azzume you already found zzome itemzz to build a proper dizzguizze? ", cid)
			npcHandler.topic[cid] = 16
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 6 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 8 then
			npcHandler:say("Zzo... you finished him. Show me hizz head, will you? ", cid)
			npcHandler.topic[cid] = 20
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 9 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 10)
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission04, 1) --Questlog, Wrath of the Emperor "Mission 04: Sacrament of the Snake"
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 11 then
			npcHandler:say("You - azzembled zze zzeptre? Hand it out, give it to me, will you? ", cid)
			npcHandler.topic[cid] = 21
		elseif player:getStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline) == 12 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 13)
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission05, 1) --Questlog, Wrath of the Emperor "Mission 05: New in Town"
			npcHandler.topic[cid] = 0
		-- WRATH OF THE EMPEROR QUEST
		end
	...
	elseif msgcontains(msg, "symbols") then
		if player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.StrangeSymbols) == 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 1)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission00, 1) --Questlog, Children of the Revolution "Prove Your Worzz!"
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(11101, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 3)
				player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission00, 2) --Questlog, Children of the Revolution "Prove Your Worzz!"
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 5 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 4)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission01, 1) --Questlog, Children of the Revolution "Mission 1: Corruption"
		...
		elseif npcHandler.topic[cid] == 6 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 7)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission02, 1) --Questlog, Children of the Revolution "Mission 2: Imperial Zzecret Weaponzz"
		...
		elseif npcHandler.topic[cid] == 8 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 9)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission03, 1) --Questlog, Children of the Revolution "Mission 3: Zee Killing Fieldzz"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 13)
			if player:getStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission04) <= 1 then
				player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission04, 1) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			end
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.StrangeSymbols, 2)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission04, 3) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 12 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 18)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission04, 6) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 13 then
			...
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Questline, 19)
			player:setStorageValue(PlayerStorageKeys.ChildrenoftheRevolution.Mission05, 1) --Questlog, Children of the Revolution "Mission 5: Phantom Army"
			npcHandler.topic[cid] = 0
		-- CHILDREN OF REVOLUTION QUEST
		...
		elseif npcHandler.topic[cid] == 15 then
			...
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 1)
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission01, 1) --Questlog, Wrath of the Emperor "Mission 01: Catering the Lions Den"
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 18 then
			if player:getItemCount(8309) >= 3 and player:getItemCount(5901) >= 1 then
				...
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 2)
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission01, 2) --Questlog, Wrath of the Emperor "Mission 01: Catering the Lions Den"
		...
		elseif npcHandler.topic[cid] == 19 then
			...
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 7)
			player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission03, 1) --Questlog, Wrath of the Emperor "Mission 03: The Keeper"
		...
		elseif npcHandler.topic[cid] == 20 then
			if player:removeItem(12323, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 9)
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission03, 3) --Questlog, Wrath of the Emperor "Mission 03: The Keeper"
				npcHandler.topic[cid] = 0
			end

		elseif npcHandler.topic[cid] == 21 then
			if player:removeItem(12327, 1) then
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Questline, 12)
				player:setStorageValue(PlayerStorageKeys.WrathoftheEmperor.Mission04, 3) --Questlog, Wrath of the Emperor "Mission 04: Sacrament of the Snake"
