...
local voices = {
	{ text = 'You gold safe at here! snickers!' },
	{ text = 'Me take all gold! Good care! Give! Give!' }
}
...
npcHandler:setMessage(MESSAGE_GREET, 'Hi there. Welcome to me gold storage called bank.')
