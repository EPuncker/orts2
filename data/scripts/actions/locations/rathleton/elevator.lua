...
local rathletonElevator = Action()

function rathletonElevator.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
rathletonElevator:id(23422, 23429)
rathletonElevator:register()
