...
local lifeRingLever = Action()

function lifeRingLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
lifeRingLever:aid(50129)
lifeRingLever:register()
