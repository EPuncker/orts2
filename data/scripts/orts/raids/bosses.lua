...
local spawnBosses = GlobalEvent("spawnBosses")

function spawnBosses.onThink(interval, lastExecution, thinkInterval)
...
spawnBosses:interval(3600000)
spawnBosses:register()
