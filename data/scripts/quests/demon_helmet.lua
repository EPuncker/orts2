local t = {
	Position(33314, 31575, 15),
	Position(33316, 31574, 15),
	Position(33322, 31592, 14)
}

local demonHelmetLever = Action()

function demonHelmetLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
