...
local teleportOut = MoveEvent()

function teleportOut.onStepIn(creature, item, position, fromPosition)
...
teleportOut:type("stepin")
teleportOut:aid(9029)
teleportOut:register()
