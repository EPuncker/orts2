local barbarianTestHorn = Action()

local function sendSleepEffect(position)
	position:sendMagicEffect(CONST_ME_SLEEP)
end

function barbarianTestHorn.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
barbarianTestHorn:id(7140, 7141, 7174, 7175, 7176)
barbarianTestHorn:register()

local barbarianTestMead = Action()

function barbarianTestMead.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
barbarianTestMead:uid(3110)
barbarianTestMead:register()
