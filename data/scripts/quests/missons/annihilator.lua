local annihilatorDoor = Action()

function annihilatorDoor.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
annihilatorDoor:aid(2214)
annihilatorDoor:register()

local annihilatorLever = Action()
...
function annihilatorLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
annihilatorLever:uid(2208)
annihilatorLever:register()
